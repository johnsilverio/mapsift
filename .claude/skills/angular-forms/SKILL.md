---
name: angular-forms
description: Build signal-based forms in Angular v22 using the Signal Forms API. Use for form creation with automatic two-way binding, schema-based validation, field state management, and dynamic forms. Triggers on form implementation, adding validation, creating multi-step forms, or building forms with conditional fields.
---

# Angular Signal Forms

Build type-safe, reactive forms using Angular's Signal Forms API. Signal Forms provide automatic two-way
binding, schema-based validation, and reactive field state.

**Status.** `form()` and the rest of `@angular/forms/signals` are **stable since v22.0**; they were
experimental in v21, and any guidance that still calls them experimental or steers production code to Reactive
Forms for stability is out of date. Reactive Forms remain supported and are the interoperability path for
existing code, documented in [references/form-patterns.md](references/form-patterns.md).

**Which one Mapsift standardizes on is not settled here.** It is an ADR gated on `specs/dependencies.md`
(`.claude/rules/angular.md`). Until it is decided, do not mix the two ad hoc inside one surface.
...
For Reactive Forms patterns, kept as the interoperability path for existing code, see
