...
export type UiBadgeTypeVariants = NonNullable<VariantProps<typeof badgeVariants>['uiType']>;
export type UiBadgeShapeVariants = NonNullable<VariantProps<typeof badgeVariants>['uiShape']>;
