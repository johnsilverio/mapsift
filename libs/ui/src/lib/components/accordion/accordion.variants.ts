...
export type UiAccordionVariants = VariantProps<typeof accordionVariants>;
export type UiAccordionItemVariants = VariantProps<typeof accordionItemVariants>;
export type UiAccordionTriggerVariants = VariantProps<typeof accordionTriggerVariants>;
export type UiAccordionContentVariants = VariantProps<typeof accordionContentVariants>;
