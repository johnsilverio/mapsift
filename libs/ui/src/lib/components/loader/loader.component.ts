...
import { loaderVariants, type UiLoaderVariants } from './loader.variants';
...
export class UiLoaderComponent {
  ...
  readonly uiSize = input<UiLoaderVariants['uiSize']>('default');
  ...
  protected readonly classes = computed(() => mergeClasses(loaderVariants({ uiSize: this.uiSize() }), this.class()));
}
