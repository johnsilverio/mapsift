...
import { UiCalendarGridComponent } from './calendar-grid.component';
import { UiCalendarNavigationComponent } from './calendar-navigation.component';
...
@Component({
  ...
  imports: [UiCalendarNavigationComponent, UiCalendarGridComponent],
  template: `
    <div [class]="classes()">
...
export class UiCalendarComponent implements ControlValueAccessor {
  private readonly gridRef = viewChild.required(UiCalendarGridComponent);
  ...
  readonly uiMode = input<CalendarMode>('single');
  ...
  protected readonly calendarDays = computed(() => {
    ...
    return generateCalendarDays({
      ...
      mode: this.uiMode(),
      selectedDates: getSelectedDatesArray(this.normalizedValue(), this.uiMode()),
