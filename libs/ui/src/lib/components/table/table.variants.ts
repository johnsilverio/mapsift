...
export type UiTableSizeVariants = NonNullable<VariantProps<typeof tableVariants>['uiSize']>;
export type UiTableTypeVariants = NonNullable<VariantProps<typeof tableVariants>['uiType']>;
