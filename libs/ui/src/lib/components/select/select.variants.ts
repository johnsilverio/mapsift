...
export const selectItemIconVariants = cva('absolute flex size-3.5 items-center justify-center', {
  variants: {
    // uiSize variants are placeholders for compound variant matching
    uiSize: {
      sm: '',
      default: '',
      lg: '',
...
export type UiSelectSizeVariants = NonNullable<VariantProps<typeof selectTriggerVariants>['uiSize']>;
export type UiSelectItemModeVariants = NonNullable<VariantProps<typeof selectItemVariants>['uiMode']>;
