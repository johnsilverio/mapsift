...
export type UiTooltipVariants = VariantProps<typeof tooltipVariants>;
...
export type UiTooltipPositionVariants = NonNullable<VariantProps<typeof tooltipPositionVariants>['position']>;
