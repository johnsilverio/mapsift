...
export type UiTreeVariants = VariantProps<typeof treeVariants>;
export type UiTreeNodeVariants = VariantProps<typeof treeNodeVariants>;
export type UiTreeNodeToggleVariants = VariantProps<typeof treeNodeToggleVariants>;
export type UiTreeNodeContentVariants = VariantProps<typeof treeNodeContentVariants>;
export type UiTreeNodeChildrenVariants = VariantProps<typeof treeNodeChildrenVariants>;
