...
@Component({
  ...
  template: `
    <div class="flex items-center border-b px-3" cmdk-input-wrapper="">
      <ui-icon uiType="search" class="mr-2 shrink-0 opacity-50" />
      <input
        #searchInput
        [class]="classes()"
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => UiCommandInputComponent),
      multi: true,
    },
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  exportAs: 'uiCommandInput',
})
export class UiCommandInputComponent implements ControlValueAccessor {
