...
export type UiButtonShapeVariants = NonNullable<VariantProps<typeof buttonVariants>['uiShape']>;
export type UiButtonSizeVariants = NonNullable<VariantProps<typeof buttonVariants>['uiSize']>;
export type UiButtonTypeVariants = NonNullable<VariantProps<typeof buttonVariants>['uiType']>;
